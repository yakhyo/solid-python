...
but we didn't modify any of the existing code.
"""
...
"""
In this example, we have a base Animal class with an abstract make_sound() 
method that all animals should implement. We also have three subclasses of 
Animal: Dog, Cat, and Cow, each of which implements the make_sound() method differently.

Now let's say we want to add a new animal, `Sheep`. 
We can do this without modifying the existing code:
"""
...
"""
We have extended the functionality of our code by adding a new animal, 
but we didn't modify any of the existing code. This is an example of the Open-Closed Principle in action.
"""
